...
export const Service = ({ title, description, icon }: ServicesProps) => {
  return (
    <div className="mt-4 p-5 sm:p-6 lg:p-8 rounded-3xl border-border 
         bg-box shadow-lg  relative overflow-hidden">
      <div className="rounded-xl bg-gray-300 dark:bg-gray-500 p-3
           text-heading-1 w-max relative">{icon}</div>
