...
export const Info = ({ title, description, children }: InfoProps) => {
  return (
    <div className="p-5 sm:p-6 lg:p-8 rounded-3xl border-border 
         bg-box shadow-lg  relative overflow-hidden">
      <div className="rounded-xl bg-gray dark:bg-gray-950 p-3 
           text-heading-1 w-max relative">{children}</div>
